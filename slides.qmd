...
::: {.r-stack}
![](images/libdivide_vs_before.png){width="72%"}
:::

::: {.fragment}
No SIMD yet — just multiply-and-shift instead of a hardware divide. Already
**~1.5–1.8×** on integer `floor_divide`.
:::

::: {.notes}
Replace images/libdivide_vs_before.png with the real chart from PR #17727 if you
have it. Numbers here are illustrative (~50% is the ballpark libdivide delivered).
Point: this is the *scalar* win — SIMD comes next and stacks on top.
:::
...
> Sometimes you're the one who broke it.
...
- **2021** — libdivide arrives ([#17727](https://github.com/numpy/numpy/pull/17727))
- **2022** — `floor_divide` → SIMD ([#18766](https://github.com/numpy/numpy/pull/18766)); `timedelta` stays on libdivide
- **2026** — last path → SIMD, **~5–6× faster** ([#32422](https://github.com/numpy/numpy/pull/32422))
...
::: {.notes}
One path (timedelta) stayed stuck on libdivide until 2026. Punchline: I finished
#32422 by feeding my own 3-year-old abandoned commit to Claude — the journey
began before the AI boom and closed with AI help. "libdivide odyssey" is the
maintainer's own words — let it land.
:::
